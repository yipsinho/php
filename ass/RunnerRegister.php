...
<?php
	...
	<h1>Register</h1>
    Profile Picture
    <input type="file" id="rpfpic">
    <br>
    First Name
    <input type="text" id="rfname" required="required">
    <br>
    Last Name
    <input type="text" id="rlname" required="required">
    <br>
    Password
    <input type="password" id="rpassword" required="required">
   	<br><label>Gender <input type="radio" name="rbGender" value="Male" checked="checked" /> Male</label>
			           <input type="radio" name="rbGender" value="Female" /> Female
					   <input type="radio" name="rbGender" value="Other" /> Other</label>
    <br>
    Date of Birth
    <input type="date" id="rdob" required="required">
    <br>
    Email
    <input type="email" id="remail" required="required">
    <br>
    Country
      <select id="rcountry" name="rcountry">
    ...
    if(isset($_POST['rfname'])) {
		...
		if(mysqli_num_rows($rs) > 0) 
			...
			if(mysqli_affected_rows($conn) > 0)
				echo "<h2>The register is successfully!</h2>";
		}
	}
?>
</body>
